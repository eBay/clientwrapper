...
class MyTestCase(unittest.TestCase):
    ...
    def test_method3(self):
        ...
        self.assertEqual(actual_tuple, (1,2,3))
        self.assertEqual(actual_dict, {'a':1,'b':2,'c':3})
        self.assertEqual(kwargs, {'str2':'str', 'int2':1, 'bool2':True, 'list2':[1,2,3], 'tuple2':(1,2,3), 'dict2':{'a':1,'b':2,'c':3}})
    def test_method4(self):
        # test with same args as method3 but all args are empty; e.g. [], (), {}, '', 0, False, None
        dummy = DummyClientWrapper()
        ...
        self.assertEqual(kwargs, {'str2':'', 'int2':None, 'bool2':False, 'list2':[], 'tuple2':(), 'dict2':{0:'zero'}})
